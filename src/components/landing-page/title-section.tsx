...
const TitleSection: React.FC<TitleSectionProps> = ({
  ...
  return <React.Fragment>
    <section className='flex flex-col gap-4 justify-center items-center md:items-center'>
      <article className='rounded-full p-[1px] text-sm dark:bg-gradiant-to-r dark:from-brand-primaryBlue dark:to-brand-primaryPurple'>
      ...
      {title}
        ...
        <p className='dark:test-washed-purple-700 sm:max-w-[450px] md:text-center'>
          {subheading}
        </p>
        </>):(
