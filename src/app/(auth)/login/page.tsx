...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center mt-[50px] sm:items-start sm:pt-12">
      <Form {...form}>
        <form
          onChange={() => {
          ...
          className="w-full max-w-md space-y-6 flex flex-col sm:mx-auto"
        >
